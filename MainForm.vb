...
#Region "Handlers"
	...
	Private Sub PlayerControls_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs)
		...
		If s.Text <> "" Then
			...
			blend.Factors = New Single() {0, 0.20000000000000001, 0.5, 0.5, 0.20000000000000001, 0}
			blend.Positions = New Single() {0, 0.20000000000000001, 0.40000000000000002, 0.59999999999999998, 0.80000000000000004, 1}
			...
			blend.Factors = New Single() {0, 0.20000000000000001, 0.5}
			blend.Positions = New Single() {0, 0.40000000000000002, 1}
